...
lvmpd_cfs_main <- read.csv("C:/Users/sdavidson/Downloads/lvmpd_cfs_main.csv")

#Get date from 7 days ago
last_week <- format(Sys.Date()-7,"%m/%d/%Y")

#Read in Data
lvmpd_cfs_rmd <- read.csv(lvmpd_cfs_path) 
  #Filter to just CFS within last week
  filter(incident_date >= mdy(last_week)) %>% 
  #Put newest events first
...
**Questions?** Contact LVRJ data editor Michael Scott Davidson at <lvrjautodata@gmail.com>
