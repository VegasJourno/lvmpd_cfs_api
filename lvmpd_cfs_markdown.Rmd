...
```{r}{r homicide_conditional_block_1, echo=FALSE, results='asis', eval= count_homicide_calls > 0}
...
```{r}{r strip_conditional_block_1, echo=FALSE, results='asis', eval= count_lv_strip_combined > 0}
